    ...
    */
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_NAME, VALID_STUDENT_ID,
                        VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_invalidSId_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_NAME, INVALID_STUDENT_ID, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_nullSId_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_NAME, null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_NAME, VALID_STUDENT_ID, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_NAME, VALID_STUDENT_ID, VALID_PHONE,
                        INVALID_EMAIL, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_NAME, VALID_STUDENT_ID, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_NAME, VALID_STUDENT_ID, VALID_PHONE,
                        VALID_EMAIL, INVALID_ADDRESS, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_NAME, VALID_STUDENT_ID, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS, new ArrayList<>());
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_NAME, VALID_STUDENT_ID, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, invalidTags, new ArrayList<>());
